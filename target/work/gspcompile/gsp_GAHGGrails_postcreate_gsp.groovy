...
class gsp_GAHGGrails_postcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(postInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(postInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:postInstance, action:'save'])],2)
printHtmlPart(22)
})
